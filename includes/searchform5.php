...
/* Permalink - use to edit and share this gradient: http://colorzilla.com/gradient-editor/#466c99+8,ededed+9,ededed+100&amp;1+0,0.46+50,1+100 */
background: -moz-linear-gradient(top,  rgba(70,108,153,1) 0%, rgba(70,108,153,0.91) 8%, rgba(237,237,237,0.9) 9%, rgba(237,237,237,0.46) 50%, rgba(237,237,237,1) 100%); /* FF3.6+ */
background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,rgba(70,108,153,1)), color-stop(8%,rgba(70,108,153,0.91)), color-stop(9%,rgba(237,237,237,0.9)), color-stop(50%,rgba(237,237,237,0.46)), color-stop(100%,rgba(237,237,237,1))); /* Chrome,Safari4+ */
background: -webkit-linear-gradient(top,  rgba(70,108,153,1) 0%,rgba(70,108,153,0.91) 8%,rgba(237,237,237,0.9) 9%,rgba(237,237,237,0.46) 50%,rgba(237,237,237,1) 100%); /* Chrome10+,Safari5.1+ */
background: -o-linear-gradient(top,  rgba(70,108,153,1) 0%,rgba(70,108,153,0.91) 8%,rgba(237,237,237,0.9) 9%,rgba(237,237,237,0.46) 50%,rgba(237,237,237,1) 100%); /* Opera 11.10+ */
background: -ms-linear-gradient(top,  rgba(70,108,153,1) 0%,rgba(70,108,153,0.91) 8%,rgba(237,237,237,0.9) 9%,rgba(237,237,237,0.46) 50%,rgba(237,237,237,1) 100%); /* IE10+ */
background: linear-gradient(to bottom,  rgba(70,108,153,1) 0%,rgba(70,108,153,0.91) 8%,rgba(237,237,237,0.9) 9%,rgba(237,237,237,0.46) 50%,rgba(237,237,237,1) 100%); /* W3C */
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#466c99', endColorstr='#ededed',GradientType=0 ); /* IE6-9 */
