	...
	function buildEventContainer() {
		daySegmentContainer =
			$("<div class='fc-event-container' style='position:absolute;z-index:8;top:0;left:0;'/>")
				...
				//daySegmentContainer2 =$("<div class='date_has_event'><div class='events'><ul><li><span class='title'><a href='event.php?eventID=1'>Samaria Gorge Tour</a></span><span class='desc'>it's a local mountain with big fun that you're looking for, then it's Hunter you want</span></li><li></li></ul></div></div>").appendTo(element);
				//daySegmentContainer2 =$("<div class='date_has_event_mine' >skata asdfkj a;sldkjf ;</br>lakdjsf;aljdkf;al</div>").appendTo(element);
...
function AgendaView(element, calendar, viewName) {
	...
	t.getListener = function() { return hoverListener };
	t.colLeft = colLeft;
	t.colRight = colRight;
	t.colContentLeft = colContentLeft;
	t.colContentRight = colContentRight;
