...
">
	...
	<form action="search.php" method="POST" id="ff1" >
		...
		<?php if(PAGE=='index.php') echo 'top:250px;z-index:1;';
		else echo 'top:110px;'?>
...
//           $(this).css('color','#B4B4B4');
		...
		<a href="javascript:$('#ff1').submit();"
		   ...
		   <?php if(PAGE=='index.php') echo 'top:250px;';
		   else echo 'top:110px;'?>
		...
		" cellspacing="5"> <!-- ***start of cart table ***-->
			...
			<td nowrap="nowrap" >
				&nbsp;<a class="top-quick-link" style="display:inline-block;padding:2px;" href="index.php" >
					<img  alt="" border="0" height="9" width="13" src="images/top_icon_home.gif"/>Αρχική Σελίδα</a></td>
			<td nowrap="nowrap">&nbsp;&nbsp;|&nbsp;&nbsp;<a href="profil.php" class="top-quick-link">Πληροφορίες</a></td>
			<td nowrap="nowrap">&nbsp;&nbsp;|&nbsp;&nbsp;<a name="" ><img alt="" border="0" height="8" width="16" src="images/top_icon_net.gif"></a>
				<a href="contact.php" class="top-quick-link">Επικοινωνία</a></td>
...
<!--			<span style="position: absolute;left:80px;top:0px;font-size: 14px;vertical-align: top;">|</span>-->
		...
		<a href="javascript:void(0);" class="drop">ΕΝΟΙΚΙΑΣΕΙΣ <img style=""  id="im1"  /></a>
		...
		-->
			...
			<div class="col_2">
				<a class="inner-link" href="search.php?sr=MIKONOS"><img width="19" height="17" src="images/blackmikonos4.png">&nbsp; Μύκονος</a>
			</div>
			...
			<div class="col_2">
				<a class="inner-link" href="search.php?sr=SANTORINI"><img style="vertical-align: middle" width="25" height="24" src="images/santorini.png"> Σαντορίνι</a>
			</div>


			<div class="col_3">
				<a class="inner-link" href="search.php?sc=HOUSE"><img style="vertical-align: middle" width="20" height="22" src="images/house1.png">&nbsp;Μονοκατοικίες</a>
			</div>
			...
			<div class="col_2">
				<a class="inner-link" href="search.php?sr=RODOS"><img style="vertical-align: middle;margin-right:6px;" width="17" height="20" src="images/rodos.png">&nbsp;  Ρόδος</a>
			</div>


			<div class="col_3">
				<a class="inner-link" href="search.php?sc=VILLA"><img style="vertical-align: middle;" width="36" height="20" src="images/villa3.png">&nbsp;Βίλλες</a>
			</div>
			...
			<div class="col_2">
				<a class="inner-link" href="search.php?sr=CYPRUS"><img style="vertical-align: middle;margin-right:-4px;" width="28" height="17" src="images/blackcyprus.png">&nbsp; Κύπρος</a>
			</div>

			<div class="col_3">
				<a class="inner-link" href="search.php?sc=SEASIDE"><img style="vertical-align: middle" width="25" height="25" src="images/blackbeach1.png">&nbsp;Παραθαλλάσια</a>
			</div>
			...
			<div class="col_3" style="display: none">
				<a class="inner-link" href="search.php?sc=APARTMENT"><img style="vertical-align: middle" width="10" height="20" src="images/apart.png">&nbsp; Διαμερίσματα</a>
			</div>
