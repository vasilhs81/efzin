...
/* Permalink - use to edit and share this gradient: http://colorzilla.com/gradient-editor/#1e5799+0,7db9e8+100&amp;0+0,1+40,1+60,0+100 */
background: -moz-linear-gradient(-45deg,  rgba(30,87,153,0) 0%, rgba(68,126,185,1) 40%, rgba(87,146,201,1) 60%, rgba(125,185,232,0) 100%); /* FF3.6+ */
background: -webkit-gradient(linear, left top, right bottom, color-stop(0%,rgba(30,87,153,0)), color-stop(40%,rgba(68,126,185,1)), color-stop(60%,rgba(87,146,201,1)), color-stop(100%,rgba(125,185,232,0))); /* Chrome,Safari4+ */
background: -webkit-linear-gradient(-45deg,  rgba(30,87,153,0) 0%,rgba(68,126,185,1) 40%,rgba(87,146,201,1) 60%,rgba(125,185,232,0) 100%); /* Chrome10+,Safari5.1+ */
background: -o-linear-gradient(-45deg,  rgba(30,87,153,0) 0%,rgba(68,126,185,1) 40%,rgba(87,146,201,1) 60%,rgba(125,185,232,0) 100%); /* Opera 11.10+ */
background: -ms-linear-gradient(-45deg,  rgba(30,87,153,0) 0%,rgba(68,126,185,1) 40%,rgba(87,146,201,1) 60%,rgba(125,185,232,0) 100%); /* IE10+ */
background: linear-gradient(135deg,  rgba(30,87,153,0) 0%,rgba(68,126,185,1) 40%,rgba(87,146,201,1) 60%,rgba(125,185,232,0) 100%); /* W3C */
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#001e5799', endColorstr='#007db9e8',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */


/* Permalink - use to edit and share this gradient: http://colorzilla.com/gradient-editor/#1e5799+0,7db9e8+100&amp;0+0,1+50,1+50,0+100 */
background: -moz-linear-gradient(left,  rgba(30,87,153,0) 0%, rgba(78,136,193,1) 50%, rgba(125,185,232,0) 100%); /* FF3.6+ */
background: -webkit-gradient(linear, left top, right top, color-stop(0%,rgba(30,87,153,0)), color-stop(50%,rgba(78,136,193,1)), color-stop(100%,rgba(125,185,232,0))); /* Chrome,Safari4+ */
background: -webkit-linear-gradient(left,  rgba(30,87,153,0) 0%,rgba(78,136,193,1) 50%,rgba(125,185,232,0) 100%); /* Chrome10+,Safari5.1+ */
background: -o-linear-gradient(left,  rgba(30,87,153,0) 0%,rgba(78,136,193,1) 50%,rgba(125,185,232,0) 100%); /* Opera 11.10+ */
background: -ms-linear-gradient(left,  rgba(30,87,153,0) 0%,rgba(78,136,193,1) 50%,rgba(125,185,232,0) 100%); /* IE10+ */
background: linear-gradient(to right,  rgba(30,87,153,0) 0%,rgba(78,136,193,1) 50%,rgba(125,185,232,0) 100%); /* W3C */
...
">
	...
	<div style="width:960px;left:50%;margin-left: -480px;position:absolute;height:auto;background: transparent;">
	<a  href="index.php" style="display:inline-block;margin-top: 50px;">
		<img src="images/logos/logo20.png"  alt="Efzin" width="364" height="116" >
	</a>
	...
	<form action="search.php" method="POST" id="ff1" >
		...
		<div style="position:absolute;top:140px;left:635px;display:inline-block;white-space:nowrap;height:40px;float:left;
...
//           $(this).css('color','#B4B4B4');
		...
		<a href="javascript:$('#ff1').submit();"
		   style="width: 22px;height: 22px;position:absolute;top:138px;left:875px;margin-top: 4px;">
...
<a href="https://www.facebook.com/pages/Efzin-Property/103974186330754"
   target="_blank" style="display:none;float:right;position:absolute;z-index:200;left:838px;top:20px;color:black;font-size:10px;"
	...
	<div style="display:none;position:absolute;left:500px;top:-10px;width: 300px; height:199px;z-index:-10;opacity:0.2"
...
<div id="mainDiv" style="width:960px;left:50%;top:240px;margin-left: -480px;position:absolute;height:auto;background: transparent;" >
