...
<table style="width: 640px;display: inline-block;height: auto;"
	...
	<tr><td align="left" colspan="2">
			<p><?=getTextByCode('SEARCH_FOUND_RESULTS_1')?> <b><?=count($search_results)?></b> <?=getTextByCode('SEARCH_FOUND_RESULTS_2')?></p>
...
<tr class="search-result-tr" data-rowid="<?=$i++?>" >
	<td><a href="property.php?pid=<?=$row['id']?>">
		<img src="photos/<?=$row['id'].'/'.$row['main_photo']?>" alt="<?=$row['title']?>"
